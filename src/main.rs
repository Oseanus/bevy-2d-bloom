...
//! URL: https://github.com/bevyengine/bevy/blob/latest/examples/2d/bloom_2d.rs
...
fn setup(mut commands: Commands, mut meshes: ResMut<Assets<Mesh>>, mut materials: ResMut<Assets<ColorMaterial>>, asset_server: Res<AssetServer>) {
    ...
    commands.spawn(MaterialMesh2dBundle {
        ...
        // 4. Put somethin bright in a dark environment to see the effect
    ...
    commands.spawn(MaterialMesh2dBundle {
        ...
        // 4. Put something bright in a dark environment
    ...
    // UI
    commands.spawn(TextBundle::from_section("", TextStyle::default()).with_style(Style {
